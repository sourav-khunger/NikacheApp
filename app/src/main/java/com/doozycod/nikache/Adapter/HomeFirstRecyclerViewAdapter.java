...
public class HomeFirstRecyclerViewAdapter extends RecyclerView.Adapter<HomeFirstRecyclerViewAdapter.MyViewHolder> {

    private Context mContext;
    private ArrayList<HomeFirstRecyclerView> homeFirstRecyclerViewList;
    HomeFirstRecyclerView homeFirstRecyclerView;
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, int position) {
        homeFirstRecyclerView = homeFirstRecyclerViewList.get(position);
        holder.title.setText(homeFirstRecyclerView.getName());
        holder.count.setText("Rs. " + homeFirstRecyclerView.getPrice());
            ...
            protected Void doInBackground(Void... params) {
                ...
                if (!isFavorite()) {
                    ...
                    productValues.put(NikacheContract.ProductEntry.COLUMN_PRODUCT_PRICE,
                            homeFirstRecyclerView.getPrice());
...
//    }
    ...
    public int getItemCount() {
        return homeFirstRecyclerViewList.size();
    }
    ...
    public HomeFirstRecyclerViewAdapter(Context mContext, ArrayList<HomeFirstRecyclerView> homeFirstRecyclerViewList){
        this.mContext = mContext;
        this.homeFirstRecyclerViewList = homeFirstRecyclerViewList;
    }
