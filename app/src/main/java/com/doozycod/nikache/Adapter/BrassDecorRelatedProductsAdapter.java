...
public class BrassDecorRelatedProductsAdapter extends RecyclerView.Adapter<BrassDecorRelatedProductsAdapter.MyViewHolder> {

    private Context mContext;
    private ArrayList<BrasDecor> brassDecorRelatedProductsList;
    BrasDecor homeFirstRecyclerView;
    ...
    @NonNull
    @Override
    public BrassDecorRelatedProductsAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.home_card1, parent, false);

        return new BrassDecorRelatedProductsAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull final BrassDecorRelatedProductsAdapter.MyViewHolder holder, int position) {
        homeFirstRecyclerView = brassDecorRelatedProductsList.get(position);
        holder.title.setText(homeFirstRecyclerView.getName());
        holder.count.setText("Rs. " + homeFirstRecyclerView.getBrassDecorPrice());
            ...
            protected Void doInBackground(Void... params) {
                ...
                if (!isFavorite()) {
                    ...
                    productValues.put(NikacheContract.ProductEntry.COLUMN_PRODUCT_PRICE,
                            homeFirstRecyclerView.getBrassDecorPrice());
...
//    }
    ...
    public int getItemCount() {
        return brassDecorRelatedProductsList.size();
    }
    ...
    public BrassDecorRelatedProductsAdapter(Context mContext, ArrayList<BrasDecor> brassDecorRelatedProductsList){
        this.mContext = mContext;
        this.brassDecorRelatedProductsList = brassDecorRelatedProductsList;
    }
