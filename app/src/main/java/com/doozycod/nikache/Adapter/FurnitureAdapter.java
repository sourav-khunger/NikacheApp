...
public class FurnitureAdapter extends RecyclerView.Adapter<FurnitureAdapter.MyViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final MyViewHolder holder, int position) {
        furniture = furnitureList.get(position);
        holder.title.setText(furniture.getName());
        holder.count.setText("Rs. " + furniture.getFurniturePrice());

        Glide.with(mContext).load(furniture.getThumbnail()).into(holder.thumbnail);
...
//                    mContext.getContentResolver().delete(NikacheContract.ProductEntry.CONTENT_URI, NikacheContract.ProductEntry.COLUMN_PRODUCT_ID + " =? ", new String[]{wallDecor.getProductId()});
                    mContext.getContentResolver().delete(NikacheContract.ProductEntry.CONTENT_URI, NikacheContract.ProductEntry.COLUMN_PRODUCT_ID + " = " + furniture.getProductId(), null);
...
//                NikacheContract.ProductEntry.COLUMN_PRODUCT_ID + " =? ", new String[]{wallDecor.getProductId()}, null);
        ...
        Cursor wallDecorCursor = mContext.getContentResolver().query(
                NikacheContract.ProductEntry.CONTENT_URI,
                new String[]{NikacheContract.ProductEntry.COLUMN_PRODUCT_ID},
                NikacheContract.ProductEntry.COLUMN_PRODUCT_ID + " = " + furniture.getProductId(), null, null);
    ...
    public FurnitureAdapter(Context mContext, List<Furniture> furnitureList){
