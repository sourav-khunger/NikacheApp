...
public class FurnitureRelatedProductsAdapter extends RecyclerView.Adapter<FurnitureRelatedProductsAdapter.MyViewHolder> {

    private Context mContext;
    private ArrayList<Furniture> furnitureRelatedProductsList;
    Furniture homeFirstRecyclerView;
    ...
    @NonNull
    @Override
    public FurnitureRelatedProductsAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.home_card1, parent, false);

        return new FurnitureRelatedProductsAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull final FurnitureRelatedProductsAdapter.MyViewHolder holder, int position) {
        homeFirstRecyclerView = furnitureRelatedProductsList.get(position);
        holder.title.setText(homeFirstRecyclerView.getName());
        holder.count.setText("Rs. " + homeFirstRecyclerView.getFurniturePrice());
            ...
            protected Void doInBackground(Void... params) {
                ...
                if (!isFavorite()) {
                    ...
                    productValues.put(NikacheContract.ProductEntry.COLUMN_PRODUCT_PRICE,
                            homeFirstRecyclerView.getFurniturePrice());
...
//    }
    ...
    public int getItemCount() {
        return furnitureRelatedProductsList.size();
    }
    ...
    public FurnitureRelatedProductsAdapter(Context mContext, ArrayList<Furniture> furnitureRelatedProductsList){
        this.mContext = mContext;
        this.furnitureRelatedProductsList = furnitureRelatedProductsList;
    }
