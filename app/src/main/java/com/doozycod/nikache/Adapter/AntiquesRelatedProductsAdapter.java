...
public class AntiquesRelatedProductsAdapter extends RecyclerView.Adapter<AntiquesRelatedProductsAdapter.MyViewHolder> {

    private Context mContext;
    private ArrayList<Antiques> antiquesRelatedProductsList;
    Antiques homeFirstRecyclerView;
    ...
    @NonNull
    @Override
    public AntiquesRelatedProductsAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.home_card1, parent, false);

        return new AntiquesRelatedProductsAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull final AntiquesRelatedProductsAdapter.MyViewHolder holder, int position) {
        homeFirstRecyclerView = antiquesRelatedProductsList.get(position);
        holder.title.setText(homeFirstRecyclerView.getName());
        holder.count.setText("Rs. " + homeFirstRecyclerView.getAntiquesPrice());
            ...
            protected Void doInBackground(Void... params) {
                ...
                if (!isFavorite()) {
                    ...
                    productValues.put(NikacheContract.ProductEntry.COLUMN_PRODUCT_PRICE,
                            homeFirstRecyclerView.getAntiquesPrice());
...
//    }
    ...
    public int getItemCount() {
        return antiquesRelatedProductsList.size();
    }
    ...
    public AntiquesRelatedProductsAdapter(Context mContext, ArrayList<Antiques> antiquesRelatedProductsList){
        this.mContext = mContext;
        this.antiquesRelatedProductsList = antiquesRelatedProductsList;
    }
