...
public class ClockRelatedProductsAdapter extends RecyclerView.Adapter<ClockRelatedProductsAdapter.MyViewHolder> {

    private Context mContext;
    private ArrayList<Clocks> clocksRelatedProductsList;
    Clocks homeFirstRecyclerView;
    ...
    @NonNull
    @Override
    public ClockRelatedProductsAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.home_card1, parent, false);

        return new ClockRelatedProductsAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull final ClockRelatedProductsAdapter.MyViewHolder holder, int position) {
        homeFirstRecyclerView = clocksRelatedProductsList.get(position);
        holder.title.setText(homeFirstRecyclerView.getName());
        holder.count.setText("Rs. " + homeFirstRecyclerView.getClocksPrice());
            ...
            protected Void doInBackground(Void... params) {
                ...
                if (!isFavorite()) {
                    ...
                    productValues.put(NikacheContract.ProductEntry.COLUMN_PRODUCT_PRICE,
                            homeFirstRecyclerView.getClocksPrice());
...
//    }
    ...
    public int getItemCount() {
        return clocksRelatedProductsList.size();
    }
    ...
    public ClockRelatedProductsAdapter(Context mContext, ArrayList<Clocks> clocksRelatedProductsList){
        this.mContext = mContext;
        this.clocksRelatedProductsList = clocksRelatedProductsList;
    }
