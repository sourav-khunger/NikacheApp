...
public class MyViewPagerAdapter3 extends PagerAdapter {
    ...
    public MyViewPagerAdapter3(Context context,TypedArray bannerArray) {
...
//        layoutInflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
        ...
        View bannerLayout = (View) inflater.inflate(R.layout.ad_banner3_home_page, container, false);

        ImageView secondBanner = (ImageView) bannerLayout.findViewById(R.id.iv_ad3);
