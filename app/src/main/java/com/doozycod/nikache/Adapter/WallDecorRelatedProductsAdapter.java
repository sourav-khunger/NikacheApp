...
public class WallDecorRelatedProductsAdapter extends RecyclerView.Adapter<WallDecorRelatedProductsAdapter.MyViewHolder> {

    private Context mContext;
    private ArrayList<WallDecor> wallDecorRelatedProductsList;
    WallDecor homeFirstRecyclerView;
    ...
    @NonNull
    @Override
    public WallDecorRelatedProductsAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.home_card1, parent, false);

        return new WallDecorRelatedProductsAdapter.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(@NonNull final WallDecorRelatedProductsAdapter.MyViewHolder holder, int position) {
        homeFirstRecyclerView = wallDecorRelatedProductsList.get(position);
        holder.title.setText(homeFirstRecyclerView.getName());
        holder.count.setText("Rs. " + homeFirstRecyclerView.getWallDecorPrice());
            ...
            protected Void doInBackground(Void... params) {
                ...
                if (!isFavorite()) {
                    ...
                    productValues.put(NikacheContract.ProductEntry.COLUMN_PRODUCT_PRICE,
                            homeFirstRecyclerView.getWallDecorPrice());
...
//    }
    ...
    public int getItemCount() {
        return wallDecorRelatedProductsList.size();
    }
    ...
    public WallDecorRelatedProductsAdapter(Context mContext, ArrayList<WallDecor> wallDecorRelatedProductsList){
        this.mContext = mContext;
        this.wallDecorRelatedProductsList = wallDecorRelatedProductsList;
    }
